...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        "*** YOUR CODE HERE ***"
        # Tìm khoảng cách đến ghost gần nhất
        ...
        if foodList:
            ...
            closestFood = 0
        # Xử lý để đưa ra giá trị hợp lý
        if closestGhost == 0:
            ghostValue = -1000
        else:
            ghostValue = -130/(closestGhost**2)
        value = ghostValue + (-2)*closestFood + (-100)*len(foodList)
        return value
    ...
    def getAction(self, gameState):
        ...
        def alphabeta(state):
            ...
            for action in state.getLegalActions(0):
                if currentNode is None:
                    currentNode = nodeMin(state.generateSuccessor(0, action), 1, 1, a, b)
                else:
        ...
        def nodeMin(state, agentIndex, depth, a, b):
            ...
            for action in state.getLegalActions(agentIndex):
                ...
                if a is not None and temp_b is not None:
                    if temp_b < a:
                        return temp_b
        ...
        def nodeMax(state, agentIndex, depth, a, b):
            ...
            for action in state.getLegalActions(agentIndex):
                ...
                if b is not None and temp_a is not None:
                    if temp_a > b:
                        return temp_a
                if a is None:
                    a = temp_a
